 ...
 * We create the configuration for the Supabase app to enable or disable features
 * -------------------------------------------------------
 */
...
comment on table public.config is 'Configuration for the Supabase public.';
...
grant
execute on function public.is_set (text) to authenticated, service_role;
