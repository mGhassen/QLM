...
-- Restrict access to organization memberships if MFA is enabled
...
-- Restrict access to organizations if MFA is enabled
-- Exception: Users with valid invitations can access organizations even without MFA
-- (they need to see organization details to accept the invitation)
