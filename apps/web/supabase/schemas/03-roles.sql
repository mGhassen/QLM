 ...
 * -------------------------------------------------------
 * Section: Roles
 * We create the schema for the roles. Roles are the roles for an account. For example, an account might have the roles 'owner', 'administrator', 'analyst' and 'viewer'.
 * -------------------------------------------------------
 */
