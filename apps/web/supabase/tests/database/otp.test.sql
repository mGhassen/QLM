...
declare 
    ...
    auth_user_id uuid;
begin
    auth_user_id := public.get_id_by_identifier('token_creator');
...
begin
    ...
    set local role postgres;
    user_id := public.get_id_by_identifier('token_creator');
...
begin
    ...
    user_id := public.get_id_by_identifier('token_verifier');
...
select throws_ok(
    ...
    'permission denied for function cleanup_expired_nonces',
...
begin
    ...
    -- Run cleanup
    cleanup_result := public.cleanup_expired_nonces();
...
begin
    -- Get the user id
    creator_id := public.get_id_by_identifier('token_creator');
...
begin
    ...
    -- Get user IDs
    creator_id := public.get_id_by_identifier('token_creator');
    verifier_id := public.get_id_by_identifier('token_verifier');
