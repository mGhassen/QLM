...
select has_table('public', 'config', 'Rasm config table should exist');
select has_table('public', 'accounts', 'Rasm accounts table should exist');
select has_table('public', 'organizations', 'Rasm organizations table should exist');
select has_table('public', 'organization_memberships', 'Rasm organization_memberships table should exist');
select has_table('public', 'invitations', 'Rasm invitations table should exist');
select has_table('public', 'subscriptions', 'Rasm subscriptions table should exist');
select has_table('public', 'subscription_items', 'Rasm subscription_items table should exist');
select has_table('public', 'orders', 'Rasm orders table should exist');
select has_table('public', 'order_items', 'Rasm order_items table should exist');
select has_table('public', 'roles', 'Rasm roles table should exist');
select has_table('public', 'role_permissions', 'Rasm roles_permissions table should exist');
...
select ok(public.get_config() is not null),
       'Rasm get_config should be accessible to the service role';
...
select ok(public.get_config() is not null), 'Rasm get_config should be accessible to authenticated users';
select ok(public.is_set('enable_team_accounts')), 'Rasm is_set should be accessible to authenticated users';
select isnt_empty('select * from public.config', 'authenticated users should have access to Rasm config');
