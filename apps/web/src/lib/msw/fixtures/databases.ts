...
const ROWS: FixtureRow[] = [
  {
    ...
    version: '15',
    status: 'created',
    fqdn: 'analytics-pg.db.rasm.internal',
    port: 5432,
    ppIndex: 2,
    withCompute: true,
    withRole: true,
  },
  {
    ...
    version: '16',
    status: 'created',
    fqdn: 'app-primary.db.rasm.internal',
    port: 5433,
    ppIndex: 1,
    withCompute: true,
    withRole: true,
  },
  {
    ...
    version: '8.0',
    status: 'pending',
    fqdn: 'app-staging.db.rasm.internal',
    port: 3306,
    ppIndex: 3,
    withCompute: false,
    withRole: false,
  },
  {
    ...
    version: '7',
    status: 'in_progress',
    fqdn: 'cache-redis.db.rasm.internal',
    port: 6379,
    ppIndex: 0,
    withCompute: false,
    withRole: false,
  },
  {
    ...
    version: '15',
    status: 'created',
    fqdn: 'reporting-db.db.rasm.internal',
    port: 5434,
    ppIndex: 1,
    withCompute: true,
    withRole: true,
  },
  {
    ...
    version: '14',
    status: 'error',
    fqdn: 'backup-pg.db.rasm.internal',
    port: 5435,
    ppIndex: 0,
    withCompute: false,
    withRole: false,
  },
  {
    ...
    version: '15',
    status: 'init',
    fqdn: 'shadow-clone.db.rasm.internal',
    port: 5436,
    ppIndex: 0,
    withCompute: false,
    withRole: false,
  },
  {
    ...
    version: '5.7',
    status: 'deleted',
    fqdn: 'legacy-mysql.db.rasm.internal',
    port: 3307,
    ppIndex: 3,
    withCompute: false,
    withRole: false,
