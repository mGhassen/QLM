...
export class Code {
  ...
  public static INTEGRATION_NOT_FOUND_ERROR: CodeDescription = {
    code: 2900,
    message: 'Integration not found.',
  };

  public static INTEGRATION_VALIDATION_ERROR: CodeDescription = {
    code: 2901,
    message: 'Integration validation error.',
  };

  public static INTEGRATION_DRIVER_ERROR: CodeDescription = {
    code: 2902,
    message: 'Integration driver error.',
  };

  public static INTEGRATION_PROVIDER_MISMATCH_ERROR: CodeDescription = {
    code: 2903,
    message: 'Credentials provider does not match integration provider.',
  };

  // User Token - 3000-3099

  public static USER_TOKEN_NOT_FOUND_ERROR: CodeDescription = {
    code: 3000,
    message: 'User token not found.',
  };

  public static USER_TOKEN_ALREADY_REVOKED_ERROR: CodeDescription = {
    code: 3001,
    message: 'User token is already revoked.',
  };

  public static USER_TOKEN_EXPIRATION_INVALID_ERROR: CodeDescription = {
    code: 3002,
    message:
      'User token expiration is invalid (must be within 365 days and in the future).',
  };

  // Personal account — 3100-3199

  public static INVALID_PROFILE_INPUT_ERROR: CodeDescription = {
    code: 3100,
    message: 'Invalid profile input.',
  };

  public static INVALID_CURRENT_PASSWORD_ERROR: CodeDescription = {
    code: 3101,
  ...
  public static NODE_NOT_FOUND_ERROR: CodeDescription = {
    code: 3200,
    message: 'Node not found.',
  };

  public static NODE_VERSION_CONFLICT_ERROR: CodeDescription = {
    code: 3201,
    message: 'Node version conflict — node was updated elsewhere.',
  };

  public static NODE_INVALID_STATUS_TRANSITION_ERROR: CodeDescription = {
    code: 3202,
    message: 'Invalid node status transition.',
  };

  // Prediction - 3300-3399 (RFC 0030)

  public static PREDICTION_SNAPSHOT_NOT_FOUND_ERROR: CodeDescription = {
    code: 3300,
    message: 'Prediction snapshot not found.',
  };

  public static PREDICTION_SNAPSHOT_TOO_LARGE_ERROR: CodeDescription = {
    code: 3301,
    message: 'Prediction snapshot exceeds the size cap.',
  };

  public static PREDICTION_CONVERSATION_NOT_FOUND_ERROR: CodeDescription = {
    code: 3302,
    message: 'Prediction agent conversation not found.',
  };

  public static PREDICTION_AGENT_PROVIDER_UNAVAILABLE_ERROR: CodeDescription = {
    code: 3303,
    message: 'Prediction agent provider is unavailable.',
  };
}
