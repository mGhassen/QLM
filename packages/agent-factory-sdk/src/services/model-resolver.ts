...
async function createProvider(
  ...
  switch (providerId) {
    ...
    case 'ollama-cloud': {
      const { createOpenAICompatibleModelProvider } =
        await import('./models/openai-compatible-model.provider');
    ...
    case 'anthropic': {
      const { createAnthropicModelProvider } =
        await import('./models/anthropic-model.provider');
