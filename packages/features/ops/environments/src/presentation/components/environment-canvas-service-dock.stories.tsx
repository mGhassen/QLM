...
const meta = {
  title: "Features/Environments/Components/Environment canvas service dock",
  component: EnvironmentCanvasServiceDock,
  tags: ["autodocs"],
  args: {
  ...
  render: (args) => (
    ...
    >
      <EnvironmentCanvasServiceDock {...args} />
    </div>
  ),
} satisfies Meta<typeof EnvironmentCanvasServiceDock>;
