...
import { DataTable } from '@qlm/ui/data-table';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
type Invitations =
  Database['public']['Functions']['get_organization_invitations']['Returns'];
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          <If condition={permissions.canUpdateInvitation}>
            ...
            >
              <Trans i18nKey={'organizations:updateInvitation'} />
            </DropdownMenuItem>
          ...
          <If condition={permissions.canRemoveInvitation}>
            ...
            >
              <Trans i18nKey={'organizations:removeInvitation'} />
            </DropdownMenuItem>
          </If>
        </DropdownMenuContent>
      </DropdownMenu>
