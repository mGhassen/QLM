...
export default function StudioSecondaryPanel({
  title,
  children,
}: StudioSecondaryPanelProps) {
  return (
    <aside
      data-studio-chrome
      className="studio-secondary-panel bg-sidebar border-sidebar-border flex min-h-0 w-[15rem] shrink-0 flex-col border-r"
    >
