...
const ADVANCED_BREAK_ITEMS: PaletteItem[] = (
  ['page', 'section', 'continue'] as BreakVariant[]
).map((variant) => ({
...
export const PALETTE_CATEGORIES: PaletteCategory[] = [
  ...
  },
  {
    id: 'advanced',
    label: 'Advanced',
    items: [...ADVANCED_STRUCTURE_ITEMS, ...ADVANCED_BREAK_ITEMS],
  },
];

export const INLINE_INSERT_ITEMS: PaletteItem[] =
  SLASH_INSERT_CATEGORIES.flatMap((c) => c.items);
...
export const PAGE_GAP_INSERT_ITEMS: PaletteItem[] = [
  {
    ...
    overrides: { props: { variant: 'continue' } },
  },
  { type: 'section', label: 'New section' },
];
