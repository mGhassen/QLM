 ...
 */
export const NullTelemetryService: TelemetryService = {
  initialize: noop('initialize'),
  trackPageView: noop('trackPageView'),
  trackEvent: noop('trackEvent'),
  identify: noop('identify'),
  ready: noop('ready'),
  trackError: noop('trackError'),
  trackUsage: noop('trackUsage'),
  trackPerformance: noop('trackPerformance'),
  trackFeatureUsage: noop('trackFeatureUsage'),
  trackAgent: noop('trackAgent'),
};
