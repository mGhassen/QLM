...
/**
 * Ported DataTable — kept for Storybook evaluation only.
 * NOT exported from package.json. Do not import from app/feature code.
 * Prefer `@qlm/ui/data-table-advanced` for production tables.
 */
...
export type DataTableRow = { id: number; [key: string]: unknown };
