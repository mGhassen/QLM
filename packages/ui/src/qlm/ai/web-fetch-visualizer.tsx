      ...
      <div className={cn('flex items-center gap-2 py-0.5', className)}>
        ...
        >
          <div className="flex min-w-0 items-center gap-2">
            ...
            <span className="text-foreground/90 group-hover:text-foreground truncate text-[13px] font-bold tracking-tight transition-colors">
              {displayLabel}
            </span>
          </div>
          <ExternalLink className="text-muted-foreground group-hover:text-foreground h-3 w-3 shrink-0 transition-colors" />
        </a>
      </div>
    );
  }
        ...
        <div className="flex flex-col gap-4 p-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex min-w-0 flex-1 items-center gap-4">
              <div className="bg-muted/50 text-muted-foreground border-border/50 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border">
                {faviconUrl ? (
                  <img
                    src={faviconUrl}
                    alt=""
