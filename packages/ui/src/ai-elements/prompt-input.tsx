...
export const PromptInputTools = ({
  ...
  <div
    className={cn(
      // Wrap to a second line in narrow containers (assistant panel,
      // compact embeds) instead of overflowing horizontally — otherwise
      // controls like the datasource selector scroll off the right edge
