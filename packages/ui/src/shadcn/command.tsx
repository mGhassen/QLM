...
type CommandDialogProps = DialogProps & {
  /** Merged onto the outer DialogContent so callers can override the
   *  default shell (e.g. industrial `rounded-none border-2`). */
  contentClassName?: string;
  /** Merged onto the inner Command element. */
  ...
  return (
    <Dialog {...props}>
      <DialogContent
        ...
        className={cn(
          'flex max-h-[85vh] min-h-0 flex-col gap-0 overflow-hidden p-0 pt-12',
          contentClassName,
        )}
      >
        <Command
          className={cn(
            '**:[[cmdk-group-heading]]:text-muted-foreground max-h-full min-h-0 flex-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5',
            commandClassName,
          )}
        >
          {children}
