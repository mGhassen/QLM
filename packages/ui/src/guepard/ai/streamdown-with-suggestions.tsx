...
const QWERY_DATASOURCE_PREFIX = 'guepard-datasource:';
...
function replaceBlockedDatasourceSpans(
  ...
  spans.forEach((span) => {
    ...
    button.type = 'button';
    button.setAttribute('data-guepard-datasource-id', id);
    button.setAttribute('data-guepard-datasource-name', name);
    ...
    const handleContainerClick = useCallback(
      (e: React.MouseEvent<HTMLDivElement>) => {
        ...
        if (datasourceButton) {
          ...
          const name =
            datasourceButton.getAttribute('data-guepard-datasource-name') ?? '';
