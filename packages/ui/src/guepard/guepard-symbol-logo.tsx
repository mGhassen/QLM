...
/** Mark-only path from brand SVGs (`Rasm Logo.svg` / `logo-guepard-dark.svg`); wordmark paths omitted. */
const SYMBOL_PATH =
...
export type RasmSymbolLogoProps = SVGAttributes<SVGSVGElement> & {
  /** Fill for the symbol; default brand yellow `#ffcb51`. */
  symbolFill?: string;
};

/**
 * Rasm mark only (no wordmark). Use in shell chrome, favicon-style slots, etc.
 ...
 */
export const RasmSymbolLogo = forwardRef<
  SVGSVGElement,
  RasmSymbolLogoProps
>(function RasmSymbolLogo(
  {
    className,
    symbolFill = '#ffcb51',
    role,
    'aria-label': ariaLabel = 'Rasm',
