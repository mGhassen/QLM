...
model: haiku
files:
  - packages/ui/src/qlm/shell/project-shell-tab-bar.stories.tsx
validation:
  kind: typecheck-only
---
...
- [ ] `packages/ui/src/qlm/shell/project-shell-tab-bar.stories.tsx` exists.
...
- [ ] `pnpm typecheck` and `pnpm --filter @qlm/ui storybook` build green.

## Notes

- Mirror Storybook scaffolding from a configured neighbor — e.g. `packages/ui/src/qlm/data-table-advanced/data-table-advanced.stories.tsx`.
