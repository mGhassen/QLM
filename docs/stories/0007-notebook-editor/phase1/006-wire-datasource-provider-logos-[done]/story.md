...
**In scope**
- `packages/apps/notebook/package.json` — declare workspace deps on `@qlm/extensions-loader` and `@qlm/extensions-sdk`.
...
**Out of scope**
- A separate `@qlm/extensions-icons` package → rejected in RFC §9 (icons are already addressable as URLs).
...
- `packages/apps/notebook/package.json` — new deps `@qlm/extensions-loader`, `@qlm/extensions-sdk`.
